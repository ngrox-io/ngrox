...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "ngrox is updating"
	case mvc.UpdateReady:
		updateMsg = "ngrox has updated: restart ngrox for the new version"
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://ngrox.com"
	default:
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "ngrox")
